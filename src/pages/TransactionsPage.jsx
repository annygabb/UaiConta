  ...
  return <div className="page-stack">
    ...
    <Panel className="filters-panel">
      ...
      <div className="filters-grid">
        ...
        <label><span>Origem</span><SelectField value={filters.imported} onChange={(value)=>patch('imported',value)} options={[{value:'todos',label:'Todas'},{value:'sim',label:'PDF'},{value:'nao',label:'Manual/recorrência'}]} ariaLabel="Filtrar por origem"/></label>
